...
algo_minmax.optimise = @optimise_emo;            % algorithm in the form [x,f,exitflag,output] = algo(problem,algo_outer,algo_inner,par_minmax)
% parameters
    ...
    par_minmax.iter_d_max = 25; %20*minmax_problem.dim_d; % Max. iterations for outer loop in an iteration of MinMaReK
    par_minmax.iter_u_max = 10; %20*minmax_problem.dim_u; % Max. iterations for inner loop in an iteration of MinMaReK
