function [algo_minmax, algo_outer, algo_inner] = init_macsminmax(minmax_problem);
...
if (minmax_problem.n_obj == 1)
    ...
    %parameters{
        ...
        par_macs.max_arch = 20;                             % Inner archive size
        par_macs.max_arch_out = 20;                         % Output archive size
