function [algo_minmax, algo_outer, algo_inner] = init_minmarek_evolve(minmax_problem, varargin);
...
% parameters
    ...
    par_minmax.keep_d_record = false;
    ...
    par_minmax.iter_d_max = 20*minmax_problem.dim_d; % Max. iterations for outer loop in an iteration of MinMaReK
    par_minmax.iter_u_max = 20*minmax_problem.dim_u; % Max. iterations for inner loop in an iteration of MinMaReK
