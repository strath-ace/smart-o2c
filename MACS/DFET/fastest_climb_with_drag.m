...
dfx = @(x,u,t) [0 1 0 0; 0 -0.5*rho0*exp(-x(3))*S*Cd*(x(2).^2/(x(2).^2+x(4).^2).^0.5+(x(2).^2+x(4).^2).^0.5) 0.5*rho0*exp(-x(3))*S*Cd*(x(2).^2+x(4).^2).^(0.5)*x(2) -0.5*rho0*exp(-x(3))*S*Cd*x(2)*x(4)/(x(2).^2+x(4).^2).^0.5; 0 0 0 1; 0 -0.5*rho0*exp(-x(3))*S*Cd*x(2)*x(4)/(x(2).^2+x(4).^2).^0.5 0.5*rho0*exp(-x(3))*S*Cd*(x(2).^2+x(4).^2).^(0.5)*x(4) -0.5*rho0*exp(-x(3))*S*Cd*(x(4).^2/(x(2).^2+x(4).^2).^0.5+(x(2).^2+x(4).^2).^0.5)];
