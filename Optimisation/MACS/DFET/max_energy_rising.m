...
x_guess = make_first_guess(f,x_0,t_0,10,u_nodes,structure);
x_guess = ones(length(x_guess),1);

%options = optimset('Display','iter','GradConstr','on','MaxFunEvals',1000000,'Tolcon',1e-9);
options = optimset('Display','iter','MaxFunEvals',1000000,'Tolcon',1e-9,'MaxIter',50000);
