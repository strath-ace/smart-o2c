...
% % Flag to 0: objective and constraints are NOT in the same function
% problem_inner.fitnessfcn.obj_constr = 0;
% % Weights for penalty
% problem_inner.fitnessfcn.w_ceq = 100;
% problem_inner.fitnessfcn.w_c   = 100;
...
% algo_inner.par.nFeValMax = 10000*length(problem_inner.ub);
