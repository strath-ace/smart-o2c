function [masked, ceq] = mask_constraints_macsminmax_max_constraint(u,par_objfun)
...
if par_objfun.sign == -1
    ...
    masked = - par_objfun.sign*func(d_true,u_true,par_func);   % par_objfun.sign_constraint*
global C
C = [C masked];
