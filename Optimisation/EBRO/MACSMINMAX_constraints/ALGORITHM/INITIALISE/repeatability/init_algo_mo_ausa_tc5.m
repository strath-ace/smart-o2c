...
% parameters
    if isfield(minmax_problem,'maxnfeval')
        par_minmax.maxnfeval = minmax_problem.maxnfeval/2;% TOTAL function evaluation limit
    else
...
if (minmax_problem.n_obj == 1)
    ...
    %parameters{
        par_macs = struct;
        par_macs.maxnfeval = 40*minmax_problem.dim_d;      % Max function evaluations
...
obj = 1;
    ...
    par_mpaidea = struct;
        par_mpaidea.nFeValMax = 800*minmax_problem.dim_u;           % number of function evaluations for IDEA
