...
switch (id)
    ...
    %     % objectives
    %     problem_minmax.n_obj = 1;
    %     problem_minmax.objfun = {@f_gianluca};            %each function is in the form [f_i] = objfun(i)(d,u,par)
    %     problem_minmax.par_objfun = {struct};
    ...
    %     dim_u = 6;
    %     problem_minmax.dim_u = dim_u;
    %     problem_minmax.lb_u = {repmat({[-5,-3,1,3]},[dim_u,1])};
    %     problem_minmax.ub_u = {repmat({[-1,0,2,5]},[dim_u,1])};
    ...
    %     dim_u = 2;
    %     problem_minmax.dim_u = dim_u;
    %     problem_minmax.lb_u = {repmat({0, 4.9999},[dim_u,1])};
    %     problem_minmax.ub_u = {repmat({5, 10},[dim_u,1])};
