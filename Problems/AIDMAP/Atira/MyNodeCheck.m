function [validflag] = MyNodeCheck(Inputs, ListNodes, newnode_ID, currentNode)
%% MyNodeCheck: This function checks the validity of the node to be created using solely the unique ID 
%
%% Inputs:
