...
filenames.AsteroidsFileName = 'AsteroidMainBelt/InputFiles/DiameterGreater150km.xlsx';
filenames.MatFileName = 'AsteroidMainBelt/InputFiles/MainBelt150Asteroids.mat';
filenames.NameFile = 'AsteroidMainBelt/InputFiles/MainBelt150Names.txt';
filenames.epochsnodename = 'AsteroidMainBelt/InputFiles/MainBelt150Epoch.mat';
filenames.orbitcharsname = 'AsteroidMainBelt/InputFiles/MainBelt150OrbitChars.mat';
...
startmeananomalies = 170; %0:10:350; %270 Best for 150km
...
startorbit = [1.9252 0.4806	0	0	180	startmeananomalies(q) epoch_start(p)];
...
options.GrowthFactorVal = 1.1e-1;                                 %Growth factor 'GF'
...
%           Sets input             %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tofvalues = 0:40:2*365;             %Set the value of the sets. 
